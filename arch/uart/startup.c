...
extern unsigned int stext, etext, _sdata, _edata, _sidata, sbss, ebss;
...
__attribute__((weak)) void ETH_IRQHandler(void) { ISR_empty(); }
__attribute__((weak)) void ETH_WKUP_IRQHandler(void) { ISR_empty(); }
__attribute__((weak)) void DCMI_IRQHandler(void) { ISR_empty(); }
