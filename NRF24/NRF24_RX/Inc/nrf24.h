...
void NRF24_FlushRX(void); //очистка
void NRF24_FlushTX(void); //буфера
void NRF24L01_RX_Mode(void); //переводим в режим приём
uint8_t NRF24_ReadReg(uint8_t addr);  //считать регистр
